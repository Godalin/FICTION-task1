...
int main()
{
    int p1 = __random_int();  // condition variable
    int lk1; // lock variable

    int p2 = __random_int();  // condition variable
    int lk2; // lock variable

    int p3 = __random_int();  // condition variable
    int lk3; // lock variable

    int p4 = __random_int();  // condition variable
    int lk4; // lock variable

    int p5 = __random_int();  // condition variable
